    ...
    <body>
        <div class="container">
            <div class="card">
                ...
                <p class="subtitle">Your app is ready. Vibe away.</p>

                <!-- Links -->
                <div class="links">
                    <a href="https://nativephp.com/docs" target="_blank" class="link">
                        <svg class="link-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                        </svg>
                        <span class="link-text">NativePHP Documentation</span>
                        <svg class="link-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M7 17L17 7M17 7H7M17 7V17"/>
                        </svg>
                    </a>

                    <a href="https://discord.gg/X62tWNStZK" target="_blank" class="link">
                ...
                <p class="footer">
                    ...
                    &middot;
                    Made with <a href="https://usebifrost.com" target="_blank">Bifrost</a>
                </p>
            </div>
        </div>
    </body>
